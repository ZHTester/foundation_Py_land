...
1 实例变量通常是用来操作实例方法的 - self
2 但是了类变量也有操作实例方法的一个变量符号 这个方法就是类方法  - cls
3 类方法与实例方法的区别 - 区别就是类与对象的一个区别 (self-cls)
  1 实例方法所关联的是我们的对象
  2 类方法所关联的是我们类本身
...
class Student(object):
    ...
    # 类方法  其中就是cls 其中类方法就是用来操作与类相关的变量 cls与self 一个是类变量一个是实例变量


student = Student("石敢当", 33)
student1 = Student("石敢当", 31)
